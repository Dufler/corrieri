...
public class BRT_TrackingByBRTshipmentIDServicesProxy implements BRT_TrackingByBRTshipmentIDServices {
  ...
  public BRT_TrackingByBRTshipmentIDServices getBRT_TrackingByBRTshipmentIDServices() {
    if (bRT_TrackingByBRTshipmentIDServices == null)
      _initBRT_TrackingByBRTshipmentIDServicesProxy();
    return bRT_TrackingByBRTshipmentIDServices;
  }
  
  public BrtTRACKINGBYBRTSHIPMENTIDResult brt_trackingbybrtshipmentid(BrtTRACKINGBYBRTSHIPMENTIDInput arg0) throws java.rmi.RemoteException{
    if (bRT_TrackingByBRTshipmentIDServices == null)
      _initBRT_TrackingByBRTshipmentIDServicesProxy();
