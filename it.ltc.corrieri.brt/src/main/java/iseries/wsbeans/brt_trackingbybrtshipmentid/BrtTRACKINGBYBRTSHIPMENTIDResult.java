...
public class BrtTRACKINGBYBRTSHIPMENTIDResult  implements java.io.Serializable {
    ...
    private String RISPOSTA_TIMESTAMP;
     ...
     * @param LISTA_EVENTI
     */
    public void setLISTA_EVENTI(Eventi[] LISTA_EVENTI) {
        this.LISTA_EVENTI = LISTA_EVENTI;
    }

    public Eventi getLISTA_EVENTI(int i) {
        return this.LISTA_EVENTI[i];
    }

    public void setLISTA_EVENTI(int i, Eventi _value) {
     ...
     * @param LISTA_NOTE
     */
    public void setLISTA_NOTE(Note[] LISTA_NOTE) {
        this.LISTA_NOTE = LISTA_NOTE;
    }

    public Note getLISTA_NOTE(int i) {
        return this.LISTA_NOTE[i];
    }

    public void setLISTA_NOTE(int i, Note _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getLISTA_EVENTI() != null) {
            for (int i=0;
                 i< Array.getLength(getLISTA_EVENTI());
                 i++) {
                Object obj = Array.get(getLISTA_EVENTI(), i);
                if (obj != null &&
        ...
        if (getLISTA_NOTE() != null) {
            for (int i=0;
                 i< Array.getLength(getLISTA_NOTE());
                 i++) {
                Object obj = Array.get(getLISTA_NOTE(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
