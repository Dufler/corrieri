...
public class BrtTRACKINGBYBRTSHIPMENTIDInput implements java.io.Serializable {
	...
	private String SPEDIZIONE_ANNO;

	private String SPEDIZIONE_BRT_ID;

	public BrtTRACKINGBYBRTSHIPMENTIDInput() {
	}

	public BrtTRACKINGBYBRTSHIPMENTIDInput(String LINGUA_ISO639_ALPHA2, String SPEDIZIONE_ANNO,
			String SPEDIZIONE_BRT_ID) {
	...
	/**
	 * Gets the LINGUA_ISO639_ALPHA2 value for this
	 * BrtTRACKINGBYBRTSHIPMENTIDInput.
	 * 
	...
	/**
	 * Sets the LINGUA_ISO639_ALPHA2 value for this
	 * BrtTRACKINGBYBRTSHIPMENTIDInput.
	 * 
	 ...
	 */
	public String getSPEDIZIONE_ANNO() {
		return SPEDIZIONE_ANNO;
	}
	 ...
	 */
	public void setSPEDIZIONE_ANNO(String SPEDIZIONE_ANNO) {
		this.SPEDIZIONE_ANNO = SPEDIZIONE_ANNO;
	}

	/**
	 * Gets the SPEDIZIONE_BRT_ID value for this
	 * BrtTRACKINGBYBRTSHIPMENTIDInput.
	 * 
	 * @return SPEDIZIONE_BRT_ID
	 */
	public String getSPEDIZIONE_BRT_ID() {
		return SPEDIZIONE_BRT_ID;
	}

	/**
	 * Sets the SPEDIZIONE_BRT_ID value for this
	 * BrtTRACKINGBYBRTSHIPMENTIDInput.
	 * 
	 * @param SPEDIZIONE_BRT_ID
	 */
	public void setSPEDIZIONE_BRT_ID(String SPEDIZIONE_BRT_ID) {
		this.SPEDIZIONE_BRT_ID = SPEDIZIONE_BRT_ID;
	}
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof BrtTRACKINGBYBRTSHIPMENTIDInput))
			return false;
		...
		_equals = true
				...
				&& ((this.SPEDIZIONE_ANNO == null && other.getSPEDIZIONE_ANNO() == null)
						|| (this.SPEDIZIONE_ANNO != null && this.SPEDIZIONE_ANNO.equals(other.getSPEDIZIONE_ANNO())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			BrtTRACKINGBYBRTSHIPMENTIDInput.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://brt_trackingbybrtshipmentid.wsbeans.iseries/",
				"brtTRACKINGBYBRTSHIPMENTIDInput"));
