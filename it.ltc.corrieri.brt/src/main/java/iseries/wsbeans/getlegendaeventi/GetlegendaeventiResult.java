...
public class GetlegendaeventiResult implements java.io.Serializable {
	...
	public GetlegendaeventiResult(int ESITO, iseries.wsbeans.getlegendaeventi.LegendaEVENTO[] LEGENDA,
			int LEGENDA_CONTATORE, int VERSIONE) {
		this.ESITO = ESITO;
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof GetlegendaeventiResult))
			return false;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			GetlegendaeventiResult.class, true);

	static {
		typeDesc.setXmlType(new QName("http://getlegendaeventi.wsbeans.iseries", "getlegendaeventiResult"));
		...
		elemField.setXmlType(new QName("http://getlegendaeventi.wsbeans.iseries", "legendaEVENTO"));
		elemField.setNillable(false);
