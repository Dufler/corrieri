...
public class BartoliniEsteroMono extends InvioFileTesto {
	...
	private static final Logger logger = Logger.getLogger(BartoliniEsteroMono.class);
	
	public static final String MESSAGGIO_CORRIERE = "TARIFFA 100COLLO DPD";

	protected BartoliniEsteroMono(CorrieriPerCliente cliente) {
		super(cliente);
